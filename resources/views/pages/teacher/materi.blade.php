...
<script>
    ...
    // Auto-open grading modal if requested from dashboard
    document.addEventListener('DOMContentLoaded', function() {
        const urlParams = new URLSearchParams(window.location.search);
        const openGradingId = urlParams.get('open_grading');
        
        if(openGradingId) {
            // Find the button (Lihat Detail) for this assignment
            // We need a way to select it. The button has data-id attribute.
