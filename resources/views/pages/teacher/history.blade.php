                                    ...
                                    <td class="px-4 py-3">
                                        <div class="d-flex justify-content-center gap-2">
                                            <span class="badge bg-success bg-opacity-10 text-success"
                                                title="Hadir">{{ $j['hadir'] }} H</span>
                                            <span class="badge bg-warning bg-opacity-10 text-warning"
                                                title="Sakit">{{ $j['sakit'] }} S</span>
                                            <span class="badge bg-info bg-opacity-10 text-info" title="Izin">{{ $j['izin'] }}
                                                I</span>
                                            <span class="badge bg-danger bg-opacity-10 text-danger" title="Alpa">{{ $j['alpa'] }}
                                                A</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-end">
                                        <button class="btn btn-sm btn-light text-primary fw-bold rounded-pill px-3"
                                            data-bs-toggle="modal" data-bs-target="#detailModal" data-id="{{ $j['id'] }}">
                                            Detail
                                        </button>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius:18px">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="d-flex flex-column gap-2" id="modalAttendanceList"
