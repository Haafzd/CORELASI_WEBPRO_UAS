  ...
  <div class="d-flex flex-column gap-5">
    ...
    <div class="d-flex align-items-end justify-content-between">
        ...
        <div class="d-none d-md-block text-end">
            ...
            <div class="fw-bold text-dark fs-5">{{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd, D MMMM Y') }}</div>
        </div>
    </div>
    ...
    <div class="row g-4 lg:g-5">
       ...
       <div class="col-12 col-lg-8">
            ...
            <div class="d-flex flex-column gap-3">
                ...
                @empty
                    <div class="d-flex align-items-center justify-content-center text-muted bg-white rounded-4 shadow-sm" style="min-height: 200px;">
            ...
            <div class="card-soft p-4 border-0 shadow-sm" style="background:white; border-radius:24px">
                ...
                <div class="d-flex flex-column gap-3">
                    @forelse($ungradedAssignments as $ua)
                        <a href="{{ route('pages.teacher.materi', ['session' => $ua->schedule_session_id]) }}?open_grading={{ $ua->id }}" class="text-decoration-none">
                            <div class="d-flex align-items-center gap-3 p-3 rounded-4 hover-lift transition-all position-relative" style="background:#FFF5F5; border:1px solid #FED7D7">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <h6 class="fw-bold text-dark mb-1" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; line-height: 1.3;">
                                        {{ $ua->title }}
                                    </h6>
                                    <div class="d-flex align-items-center gap-2 text-muted small">
                                        <span class="badge bg-white text-danger border border-danger-subtle px-2 py-0 rounded-pill fs-xs">{{ $ua->submissions_count }} Siswa</span>
