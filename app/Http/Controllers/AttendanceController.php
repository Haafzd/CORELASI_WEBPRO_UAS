...
class AttendanceController extends Controller
{
    public function scan(Request $request): JsonResponse
    {
        ...
        // 1. Secure Logic: Ensure student matches the classroom
        ...
        // 2. Find or Create Teaching Journal (BAP) for this session + date
        //    Attendance IS LINKED to a Journal, not directly to session.
        ...
        $rec = AttendanceRecord::updateOrCreate(
            ...
            [
              'status'=>'Hadir',
              // 'recorded_by_nip'=>$request->user()->id ?? 't-19800101', // Column might not exist in AttendanceRecord, check model fillable
              // checked model: fillable = ['teaching_journal_id', 'student_nis', 'status', 'notes']
              // recorded_by_nip is missing from fillable/schema based on error likely.
              // Let's stick to fillable.
